...
mkdir -p "$DEST"
for skill in backlink-assembly-line backlink-pack-generator saas-listing-pack backlink-live-validator infographic-backlink ppt-pdf-backlink competitor-link-gap; do
  rm -rf "$DEST/$skill"
